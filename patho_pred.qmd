...
# PCA on full dataset by status and subject
...
lapply(data_sub, \(x) {
  ...
  cross_table <<- rbind(x = cross_table, y = vip_table, by = 0)
...
mutate(
  .data = cross_table,
  mean = ifelse(mean > 0,
    paste0("<span style='color:green;'>&#9650; ", mean, "</span>"),
    paste0("<span style='color:red;'>&#9660; ", mean, "</span>")
  ),
  sd = ifelse(sd > 0,
    paste0("<span style='color:green;'>&#9650; ", sd, "</span>"),
    paste0("<span style='color:red;'>&#9660; ", sd, "</span>")
  ),
  median = ifelse(median > 0,
    paste0("<span style='color:green;'>&#9650; ", median, "</span>"),
    paste0("<span style='color:red;'>&#9660; ", median, "</span>")
  ),
  min = ifelse(min > 0,
    paste0("<span style='color:green;'>&#9650; ", min, "</span>"),
    paste0("<span style='color:red;'>&#9660; ", min, "</span>")
  ),
  max = ifelse(max > 0,
    paste0("<span style='color:green;'>&#9650; ", max, "</span>"),
    paste0("<span style='color:red;'>&#9660; ", max, "</span>")
  )
) |>
